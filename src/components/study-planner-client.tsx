      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Here is the schedule generated by our AI. You can refine it below or download it as a PDF.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="printable-area prose prose-stone dark:prose-invert max-w-none rounded-lg border bg-muted/30 p-6">
              <p className="whitespace-pre-wrap font-body">{schedule}</p>
            </div>
          </CardContent>
        </Card>
